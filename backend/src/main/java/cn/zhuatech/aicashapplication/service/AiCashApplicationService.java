...
import cn.zhuatech.aicashapplication.domain.DomainCatalog;
import cn.zhuatech.aicashapplication.model.*;
import cn.zhuatech.aicashapplication.repository.*;
 ...
 */
@Service
public class AiCashApplicationService {
     ...
     * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
     */
    public AiCashApplicationService(BusinessRecordRepository records,AuditLogRepository audits,SystemSettingRepository settings,DomainCatalog catalog){
